...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "totem-resources.c" 2
# 28 "totem-resources.c"
# 1 "../config.h" 1
# 29 "totem-resources.c" 2
...
gboolean g_close (gint fd,
                  GError **error);
# 244 "/usr/include/glib-2.0/glib/gstdio.h"
...
#pragma clang diagnostic push
# 260 "/usr/include/glib-2.0/glib/gstdio.h"
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
#pragma clang diagnostic push
# 277 "/usr/include/glib-2.0/glib/gstdio.h"
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
extern int getrlimit (__rlimit_resource_t __resource,
        struct rlimit *__rlimits) __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
# 70 "/usr/include/sys/resource.h" 3 4
extern int setrlimit (__rlimit_resource_t __resource,
        const struct rlimit *__rlimits) __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 38 "totem-resources.c" 2

# 1 "./totem-resources.h" 1
# 33 "./totem-resources.h"
void totem_resources_monitor_start (const char *input,
      gint wall_clock_time);
void totem_resources_monitor_stop (void);
# 40 "totem-resources.c" 2





static guint sleep_time = (30 * 1000000);
static gboolean finished = (!(0));
...
set_resource_limits (const char *input)
{
 ...
 if (input == ((void*)0)) {
  max = (256 * 1024 * 1024);
 } else if (stat (input, &buf) == 0) {
  max = (256 * 1024 * 1024) + buf.st_size;
 } else if ((__builtin_constant_p ("file://")? __extension__ ({ const char * const __str = (input); const char * const __prefix = ("file://"); gboolean __result = (0); if (__str == ((void*)0) || __prefix == ((void*)0)) __result = (g_str_has_prefix) (__str, __prefix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __prefix_len = strlen (((__prefix) + !(__prefix))); if (__str_len >= __prefix_len) __result = memcmp (((__str) + !(__str)), ((__prefix) + !(__prefix)), __prefix_len) == 0; } __result; }) : (g_str_has_prefix) (input, "file://") ) != (0)) {
  char *file;
  file = g_filename_from_uri (input, ((void*)0), ((void*)0));
  if (file != ((void*)0) && stat (file, &buf) == 0)
   max = (256 * 1024 * 1024) + buf.st_size;
  g_free (file);
 }
...
__attribute__ ((__noreturn__)) static gpointer
