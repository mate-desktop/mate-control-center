...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if ((weak_pointer) == ((void*)0)) ; else g_assertion_message (((gchar*) 0), "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
