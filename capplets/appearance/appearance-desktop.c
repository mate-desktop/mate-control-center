...
static void
select_item(AppearanceData* data, MateWPItem* item, gboolean scroll)
{
    GtkTreePath* path;
...
static MateWPItem*
get_selected_item(AppearanceData* data, GtkTreeIter* iter)
{
...
static gboolean
predicate (gpointer key, gpointer value, gpointer data)
{
    MateBG *bg = data;
...
static void
on_item_changed (MateBG *bg, AppearanceData *data)
{
    GtkTreeModel *model;
    GtkTreeIter iter;
    GtkTreePath *path;
