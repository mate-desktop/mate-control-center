...
static void
sample_draw(GtkWidget* darea, cairo_t* cr)
{
...
static void
set_fontoptions(PangoContext *context, Antialiasing antialiasing, Hinting hinting)
{
...
static void
setup_font_sample(GtkWidget* darea, Antialiasing antialiasing, Hinting hinting)
{
...
cb_details_response (GtkDialog *dialog, gint response_id)
{
    ...
    {
        capplet_help (GTK_WINDOW (dialog), "goscustdesk-38");
    } else {
