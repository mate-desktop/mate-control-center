...
static void create_thumbnail    (const gchar    *name,
...
static void
treeview_gsettings_changed_callback (GSettings      *settings,
                                     gchar          *key,
                                     GtkTreeView    *list)
{
    GtkTreeModel *store;
...
static void
treeview_selection_changed_callback (GtkTreeSelection   *selection,
                                     guint              data)
{
    GSettings *settings;
    gchar *key;
...
static void
update_color_buttons_from_string (const gchar       *color_scheme,
                                  AppearanceData    *data)
{
...
static void
color_button_clicked_cb (GtkWidget      *colorbutton,
                         AppearanceData *data)
{
    GtkWidget *widget;
    GdkRGBA color;
...
static void
color_scheme_defaults_button_clicked_cb (GtkWidget      *button,
                                         AppearanceData *data)
{
...
static void
style_response_cb (GtkDialog    *dialog,
                   gint         response_id)
{
...
static void
window_theme_changed (GSettings         *settings,
                      gchar             *key,
                      AppearanceData    *data)
{
    MateThemeInfo *theme = NULL;
...
static void
icon_theme_changed (GSettings       *settings,
                    gchar           *key,
                    AppearanceData  *data)
{
...
static void
cursor_size_changed_cb (int             size,
                        AppearanceData  *data)
{
...
static void
cursor_size_scale_value_changed_cb (GtkRange        *range,
                                    AppearanceData  *data)
{
...
static void
cursor_theme_changed (GSettings         *settings,
                      gchar             *key,
                      AppearanceData    *data)
{
...
static void
generic_theme_delete (const gchar       *tv_name,
                      ThemeType         type,
                      AppearanceData    *data)
{
...
static void
gtk_theme_delete_cb (GtkWidget      *button,
                     AppearanceData *data)
{
...
static void
window_theme_delete_cb (GtkWidget       *button,
                        AppearanceData  *data)
{
...
static void
icon_theme_delete_cb (GtkWidget         *button,
                      AppearanceData    *data)
{
...
static void
cursor_theme_delete_cb (GtkWidget       *button,
                        AppearanceData  *data)
{
                    ...
                    AppearanceData  *data)
{
    ...
    if (theme_find_in_model (GTK_TREE_MODEL (model), theme_name, &iter))
    {
        gtk_list_store_set (model, &iter, COL_LABEL, theme_label,
                            COL_NAME, theme_name,
                            -1);
    }
}
...
static void
create_thumbnail (const gchar       *name,
                  GdkPixbuf         *default_thumb,
                  AppearanceData    *data)
{
...
static void
prepare_list (AppearanceData    *data,
              GtkWidget         *list,
              ThemeType         type,
              GCallback         callback)
{
