...
static gboolean
mate_wp_xml_get_bool (const xmlNode* parent, const char* prop_name)
{
...
static void
mate_wp_xml_set_bool (const xmlNode* parent, const xmlChar* prop_name, gboolean value)
{
    if (parent != NULL && prop_name != NULL)
    {
        if (value)
...
static void
mate_wp_load_legacy (AppearanceData* data)
{
    /* Legacy of GNOME2
...
static void
mate_wp_xml_load_xml (AppearanceData* data, const char* filename)
{
    xmlDoc* wplist;
    xmlNode* root;
    xmlNode* list;
...
static void
mate_wp_file_changed (GFileMonitor* monitor, GFile* file, GFile* other_file, GFileMonitorEvent event_type, AppearanceData* data)
{
    char* filename;
...
static void
mate_wp_xml_add_monitor (GFile* directory, AppearanceData* data)
{
    GError* error = NULL;
...
static void
mate_wp_xml_load_from_dir (const char* path, AppearanceData* data)
{
    GFile* directory;
...
void
mate_wp_xml_load_list (AppearanceData* data)
{
...
static void
mate_wp_list_flatten (const char* key, MateWPItem* item, GSList** list)
{
...
void
mate_wp_xml_save_list (AppearanceData* data)
{
    xmlDoc* wplist;
    xmlNode* root;
    xmlNode* wallpaper;
