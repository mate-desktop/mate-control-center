...
static void
process_local_theme (GtkWindow  *parent, const char *path)
{
    GtkWidget *dialog;
    gint filetype;
...
static void
transfer_done_cb (GtkWidget *dialog, TransferData *tdata)
{
...
void
mate_theme_install (GFile *file, GtkWindow *parent)
{
    GtkWidget *dialog;
    gchar *path, *base;
    GList *src, *target;
