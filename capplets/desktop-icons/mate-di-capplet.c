...
{
	gboolean show_icons = gtk_toggle_button_get_active(GTK_BUTTON(button));
...
edit_computer_icon_name_cb(GtkWidget* button, MateDICapplet* capplet)
{
	...
	if (strcmp(gtk_button_get_label(GTK_BUTTON(button)), "gtk-edit") == 0)
	{
		gtk_widget_hide(capplet->button_computer_toggle);
		gtk_entry_set_text(GTK_ENTRY(capplet->entry_computer), gtk_button_get_label(capplet->button_computer_toggle));
...
edit_home_icon_name_cb(GtkWidget* button, MateDICapplet* capplet)
{
	...
	if (strcmp(gtk_button_get_label(GTK_BUTTON(button)), "gtk-edit") == 0)
	{
		...
		gtk_entry_set_text(GTK_ENTRY(capplet->entry_home), gtk_button_get_label(capplet->button_home_toggle));
...
edit_trash_icon_name_cb(GtkWidget* button, MateDICapplet* capplet)
{
	...
	if (strcmp(gtk_button_get_label(GTK_BUTTON(button)), "gtk-edit") == 0)
	{
		...
		gtk_entry_set_text(GTK_ENTRY(capplet->entry_trash), gtk_button_get_label(capplet->button_trash_toggle));
...
edit_network_icon_name_cb(GtkWidget* button, MateDICapplet* capplet)
{
	...
	if (strcmp(gtk_button_get_label(GTK_BUTTON(button)), "gtk-edit") == 0)
	{
		...
		gtk_entry_set_text(GTK_ENTRY(capplet->entry_network), gtk_button_get_label(capplet->button_network_toggle));
...
init_dialog(MateDICapplet* capplet)
{
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(capplet->button_show_icons_toggle), g_settings_get_boolean(capplet->show_icons_settings, SHOW_ICONS_KEY));
