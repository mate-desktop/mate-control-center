...
void
xkl_layout_chooser_add_default_switcher_if_necessary (GSList * layouts_list)
{
...
xkb_layout_chooser_print (GtkBuilder * chooser_dialog)
{
    ...
    matekbd_keyboard_drawing_print (
...
xkb_layout_chooser_get_selected_id (GtkBuilder * chooser_dialog)
{
    ...
    gtk_tree_model_get (vm, &viter, COMBO_BOX_MODEL_COL_XKB_ID,
                        &v_id, -1);
